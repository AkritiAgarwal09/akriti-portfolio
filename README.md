...
I work at the intersection of **modeling, systems, and scale** — building intelligent systems that hold up in production, not just in notebooks.
...
Update portfolio copy in `src/data/` — experiences, projects, research, education, and more.
